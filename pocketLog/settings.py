...
POCKET_LOG_BASE_URL = env.str('POCKET_LOG_BASE_URL')
...
GOOGLE_REDIRECT_PATH = env.str('GOOGLE_REDIRECT_PATH')
GOOGLE_REDIRECT_URI = POCKET_LOG_BASE_URL + GOOGLE_REDIRECT_PATH
# GOOGLE OAuth Config End

PASSWORD_CHANGE_REQUEST_HASH_KEY = env.str('PASSWORD_CHANGE_REQUEST_HASH_KEY')
PASSWORD_RESET_TOKEN_EXPIRY_MINUTES = env.int('PASSWORD_RESET_TOKEN_EXPIRY_MINUTES', 15)
